 ...
 *
 * <p>Pick by what the listener is for, not by how much it wants to win: a
 * listener that decides something is {@code FIRST} or {@code LAST}, and one
 * that only wants to know what was decided is {@code MONITOR}.
 */
